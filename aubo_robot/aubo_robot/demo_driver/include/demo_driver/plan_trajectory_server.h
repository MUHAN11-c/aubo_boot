...
#include <demo_interface/PlanTrajectory.h>
...
private:
    ...
    // 服务服务器
    ros::ServiceServer plan_trajectory_service_;  // 规划轨迹服务

    // 服务回调函数
    bool planTrajectoryCallback(demo_interface::PlanTrajectory::Request& req,
                               demo_interface::PlanTrajectory::Response& res);

    // 辅助函数
    bool planTrajectory(const geometry_msgs::Pose& target_pose,
                        bool use_joints,

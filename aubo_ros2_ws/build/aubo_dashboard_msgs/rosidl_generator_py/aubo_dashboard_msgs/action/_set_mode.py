...
class Metaclass_SetMode_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('aubo_dashboard_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetMode_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_dashboard_msgs.action import SetMode
...
class SetMode_SendGoal_Request(metaclass=Metaclass_SetMode_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'aubo_dashboard_msgs/SetMode_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['aubo_dashboard_msgs', 'action'], 'SetMode_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from aubo_dashboard_msgs.action._set_mode import SetMode_Goal
...
class Metaclass_SetMode_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.action.SetMode_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.action import _set_mode
...
class SetMode_SendGoal(metaclass=Metaclass_SetMode_SendGoal):
    from aubo_dashboard_msgs.action._set_mode import SetMode_SendGoal_Request as Request
    from aubo_dashboard_msgs.action._set_mode import SetMode_SendGoal_Response as Response
...
class SetMode_GetResult_Response(metaclass=Metaclass_SetMode_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'aubo_dashboard_msgs/SetMode_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['aubo_dashboard_msgs', 'action'], 'SetMode_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from aubo_dashboard_msgs.action._set_mode import SetMode_Result
...
class Metaclass_SetMode_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.action.SetMode_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SetMode_GetResult(metaclass=Metaclass_SetMode_GetResult):
    from aubo_dashboard_msgs.action._set_mode import SetMode_GetResult_Request as Request
    from aubo_dashboard_msgs.action._set_mode import SetMode_GetResult_Response as Response
...
class Metaclass_SetMode_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.action.SetMode_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SetMode_FeedbackMessage(metaclass=Metaclass_SetMode_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'aubo_dashboard_msgs/SetMode_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['aubo_dashboard_msgs', 'action'], 'SetMode_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from aubo_dashboard_msgs.action._set_mode import SetMode_Feedback
...
class Metaclass_SetMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.action.SetMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SetMode(metaclass=Metaclass_SetMode):
    ...
    from aubo_dashboard_msgs.action._set_mode import SetMode_Goal as Goal
    # The result message defined in the action definition.
    from aubo_dashboard_msgs.action._set_mode import SetMode_Result as Result
    # The feedback message defined in the action definition.
    from aubo_dashboard_msgs.action._set_mode import SetMode_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from aubo_dashboard_msgs.action._set_mode import SetMode_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from aubo_dashboard_msgs.action._set_mode import SetMode_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from aubo_dashboard_msgs.action._set_mode import SetMode_FeedbackMessage as FeedbackMessage

...
class Metaclass_GetProgramState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_dashboard_msgs.msg import ProgramState
...
class GetProgramState_Response(metaclass=Metaclass_GetProgramState_Response):
    ...
    _fields_and_field_types = {
        'state': 'aubo_dashboard_msgs/ProgramState',
        'program_name': 'string',
        'answer': 'string',
        'success': 'boolean',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['aubo_dashboard_msgs', 'msg'], 'ProgramState'),  # noqa: E501
...
class Metaclass_GetProgramState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.srv.GetProgramState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.srv import _get_program_state
...
class GetProgramState(metaclass=Metaclass_GetProgramState):
    from aubo_dashboard_msgs.srv._get_program_state import GetProgramState_Request as Request
    from aubo_dashboard_msgs.srv._get_program_state import GetProgramState_Response as Response

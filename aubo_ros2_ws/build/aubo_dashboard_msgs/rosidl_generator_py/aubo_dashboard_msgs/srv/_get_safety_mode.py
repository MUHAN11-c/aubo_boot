...
class Metaclass_GetSafetyMode_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_dashboard_msgs.msg import SafetyMode
...
class GetSafetyMode_Response(metaclass=Metaclass_GetSafetyMode_Response):
    ...
    _fields_and_field_types = {
        'safety_mode': 'aubo_dashboard_msgs/SafetyMode',
        'answer': 'string',
        'success': 'boolean',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['aubo_dashboard_msgs', 'msg'], 'SafetyMode'),  # noqa: E501
...
class Metaclass_GetSafetyMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.srv.GetSafetyMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.srv import _get_safety_mode
...
class GetSafetyMode(metaclass=Metaclass_GetSafetyMode):
    from aubo_dashboard_msgs.srv._get_safety_mode import GetSafetyMode_Request as Request
    from aubo_dashboard_msgs.srv._get_safety_mode import GetSafetyMode_Response as Response

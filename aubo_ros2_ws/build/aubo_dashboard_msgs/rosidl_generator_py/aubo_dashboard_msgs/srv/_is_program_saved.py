...
class Metaclass_IsProgramSaved(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.srv.IsProgramSaved')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.srv import _is_program_saved
...
class IsProgramSaved(metaclass=Metaclass_IsProgramSaved):
    from aubo_dashboard_msgs.srv._is_program_saved import IsProgramSaved_Request as Request
    from aubo_dashboard_msgs.srv._is_program_saved import IsProgramSaved_Response as Response

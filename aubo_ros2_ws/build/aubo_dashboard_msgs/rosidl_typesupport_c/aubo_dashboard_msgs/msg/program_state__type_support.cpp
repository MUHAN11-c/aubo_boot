...
static const _ProgramState_type_support_symbol_names_t _ProgramState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, ProgramState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, msg, ProgramState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, msg, ProgramState)() {
  return &::aubo_dashboard_msgs::msg::rosidl_typesupport_c::ProgramState_message_type_support_handle;
}

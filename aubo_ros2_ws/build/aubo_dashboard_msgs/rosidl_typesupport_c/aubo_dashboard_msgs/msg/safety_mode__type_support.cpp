...
static const _SafetyMode_type_support_symbol_names_t _SafetyMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, SafetyMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, msg, SafetyMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, msg, SafetyMode)() {
  return &::aubo_dashboard_msgs::msg::rosidl_typesupport_c::SafetyMode_message_type_support_handle;
}

...
static const _Load_Request_type_support_symbol_names_t _Load_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, Load_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, Load_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, Load_Request)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::Load_Request_message_type_support_handle;
}
...
static const _Load_Response_type_support_symbol_names_t _Load_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, Load_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, Load_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_aubo_dashboard_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, Load_Response)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::Load_Response_message_type_support_handle;
}
...
static const _Load_type_support_symbol_names_t _Load_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, Load)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, Load)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, Load)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::Load_service_type_support_handle;
}

...
static const _Popup_Request_type_support_symbol_names_t _Popup_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, Popup_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, Popup_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, Popup_Request)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::Popup_Request_message_type_support_handle;
}
...
static const _Popup_Response_type_support_symbol_names_t _Popup_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, Popup_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, Popup_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_aubo_dashboard_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, Popup_Response)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::Popup_Response_message_type_support_handle;
}
...
static const _Popup_type_support_symbol_names_t _Popup_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, Popup)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, Popup)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, Popup)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::Popup_service_type_support_handle;
}

...
static const _RawRequest_Request_type_support_symbol_names_t _RawRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, RawRequest_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, RawRequest_Request)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::RawRequest_Request_message_type_support_handle;
}
...
static const _RawRequest_Response_type_support_symbol_names_t _RawRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, RawRequest_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_aubo_dashboard_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, RawRequest_Response)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::RawRequest_Response_message_type_support_handle;
}
...
static const _RawRequest_type_support_symbol_names_t _RawRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, RawRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aubo_dashboard_msgs, srv, RawRequest)() {
  return &::aubo_dashboard_msgs::srv::rosidl_typesupport_c::RawRequest_service_type_support_handle;
}

...
static const _ProgramState_type_support_symbol_names_t _ProgramState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, msg, ProgramState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aubo_dashboard_msgs, msg, ProgramState)),
  }
};
...
get_message_type_support_handle<aubo_dashboard_msgs::msg::ProgramState>()
{
  return &::aubo_dashboard_msgs::msg::rosidl_typesupport_cpp::ProgramState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aubo_dashboard_msgs, msg, ProgramState)() {
  return get_message_type_support_handle<aubo_dashboard_msgs::msg::ProgramState>();
}

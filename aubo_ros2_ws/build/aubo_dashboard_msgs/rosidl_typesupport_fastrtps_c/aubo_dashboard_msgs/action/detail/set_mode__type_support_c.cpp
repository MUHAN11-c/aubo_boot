...
#include "aubo_dashboard_msgs/action/detail/set_mode__rosidl_typesupport_fastrtps_c.h"
...
#include "aubo_dashboard_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SetMode_Goal__ros_msg_type = aubo_dashboard_msgs__action__SetMode_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_Goal(
  const void * untyped_ros_message,
...
static uint32_t _SetMode_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_Goal(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_Goal(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Goal)() {
...
using _SetMode_Result__ros_msg_type = aubo_dashboard_msgs__action__SetMode_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_Result__ros_msg_type * ros_message = static_cast<const _SetMode_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_Result(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_Result(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Result)() {
...
using _SetMode_Feedback__ros_msg_type = aubo_dashboard_msgs__action__SetMode_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_Feedback__ros_msg_type * ros_message = static_cast<const _SetMode_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_Feedback(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_Feedback(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Feedback)() {
...
// already included above
// #include "aubo_dashboard_msgs/action/detail/set_mode__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_aubo_dashboard_msgs
...
using _SetMode_SendGoal_Request__ros_msg_type = aubo_dashboard_msgs__action__SetMode_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _SetMode_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_aubo_dashboard_msgs__action__SetMode_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_aubo_dashboard_msgs__action__SetMode_Goal(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_SendGoal_Request)() {
...
using _SetMode_SendGoal_Response__ros_msg_type = aubo_dashboard_msgs__action__SetMode_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _SetMode_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_SendGoal_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_SendGoal)() {
...
using _SetMode_GetResult_Request__ros_msg_type = aubo_dashboard_msgs__action__SetMode_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_GetResult_Request__ros_msg_type * ros_message = static_cast<const _SetMode_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_GetResult_Request)() {
...
// already included above
// #include "aubo_dashboard_msgs/action/detail/set_mode__functions.h"  // result
...
using _SetMode_GetResult_Response__ros_msg_type = aubo_dashboard_msgs__action__SetMode_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_GetResult_Response__ros_msg_type * ros_message = static_cast<const _SetMode_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_aubo_dashboard_msgs__action__SetMode_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_aubo_dashboard_msgs__action__SetMode_Result(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_GetResult_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_GetResult)() {
...
// already included above
// #include "aubo_dashboard_msgs/action/detail/set_mode__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _SetMode_FeedbackMessage__ros_msg_type = aubo_dashboard_msgs__action__SetMode_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__action__SetMode_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _SetMode_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_aubo_dashboard_msgs__action__SetMode_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__action__SetMode_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__action__SetMode_FeedbackMessage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_aubo_dashboard_msgs__action__SetMode_Feedback(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_aubo_dashboard_msgs__action__SetMode_FeedbackMessage(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, action, SetMode_FeedbackMessage)() {

...
#include "aubo_dashboard_msgs/msg/detail/program_state__rosidl_typesupport_fastrtps_c.h"
...
using _ProgramState__ros_msg_type = aubo_dashboard_msgs__msg__ProgramState;
...
static uint32_t _ProgramState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__msg__ProgramState(
...
{
  return max_serialized_size_aubo_dashboard_msgs__msg__ProgramState(
    full_bounded, 0);
}

...
#include "aubo_dashboard_msgs/msg/detail/robot_mode__rosidl_typesupport_fastrtps_c.h"
...
using _RobotMode__ros_msg_type = aubo_dashboard_msgs__msg__RobotMode;
...
static uint32_t _RobotMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__msg__RobotMode(
...
{
  return max_serialized_size_aubo_dashboard_msgs__msg__RobotMode(
    full_bounded, 0);
}

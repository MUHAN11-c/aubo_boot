...
#include "aubo_dashboard_msgs/msg/detail/safety_mode__rosidl_typesupport_fastrtps_c.h"
...
using _SafetyMode__ros_msg_type = aubo_dashboard_msgs__msg__SafetyMode;
...
static uint32_t _SafetyMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__msg__SafetyMode(
...
{
  return max_serialized_size_aubo_dashboard_msgs__msg__SafetyMode(
    full_bounded, 0);
}

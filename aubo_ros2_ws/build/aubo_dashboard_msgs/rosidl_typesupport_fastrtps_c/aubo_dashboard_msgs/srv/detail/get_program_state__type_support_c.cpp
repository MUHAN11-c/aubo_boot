...
#include "aubo_dashboard_msgs/srv/detail/get_program_state__rosidl_typesupport_fastrtps_c.h"
...
using _GetProgramState_Request__ros_msg_type = aubo_dashboard_msgs__srv__GetProgramState_Request;
...
size_t get_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetProgramState_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetProgramState_Request)() {
...
#include "aubo_dashboard_msgs/msg/detail/program_state__functions.h"  // state
#include "rosidl_runtime_c/string.h"  // answer, program_name
#include "rosidl_runtime_c/string_functions.h"  // answer, program_name

// forward declare type support functions
size_t get_serialized_size_aubo_dashboard_msgs__msg__ProgramState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_aubo_dashboard_msgs__msg__ProgramState(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, ProgramState)();


using _GetProgramState_Response__ros_msg_type = aubo_dashboard_msgs__srv__GetProgramState_Response;
  ...
  // Field name: state
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, ProgramState
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetProgramState_Response__ros_msg_type * ros_message = static_cast<const _GetProgramState_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_aubo_dashboard_msgs__msg__ProgramState(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_aubo_dashboard_msgs__msg__ProgramState(
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__GetProgramState_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetProgramState_Response)() {
...
// already included above
// #include "aubo_dashboard_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_dashboard_msgs/srv/get_program_state.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetProgramState)() {

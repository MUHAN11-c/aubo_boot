...
#include "aubo_dashboard_msgs/srv/detail/get_robot_mode__rosidl_typesupport_fastrtps_c.h"
...
using _GetRobotMode_Request__ros_msg_type = aubo_dashboard_msgs__srv__GetRobotMode_Request;
...
size_t get_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetRobotMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetRobotMode_Request)() {
...
#include "aubo_dashboard_msgs/msg/detail/robot_mode__functions.h"  // robot_mode
#include "rosidl_runtime_c/string.h"  // answer
#include "rosidl_runtime_c/string_functions.h"  // answer

// forward declare type support functions
size_t get_serialized_size_aubo_dashboard_msgs__msg__RobotMode(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_aubo_dashboard_msgs__msg__RobotMode(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, RobotMode)();


using _GetRobotMode_Response__ros_msg_type = aubo_dashboard_msgs__srv__GetRobotMode_Response;
  ...
  // Field name: robot_mode
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, RobotMode
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetRobotMode_Response__ros_msg_type * ros_message = static_cast<const _GetRobotMode_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_aubo_dashboard_msgs__msg__RobotMode(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: robot_mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_aubo_dashboard_msgs__msg__RobotMode(
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__GetRobotMode_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetRobotMode_Response)() {
...
// already included above
// #include "aubo_dashboard_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_dashboard_msgs/srv/get_robot_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetRobotMode)() {

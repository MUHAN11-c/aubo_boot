...
#include "aubo_dashboard_msgs/srv/detail/get_safety_mode__rosidl_typesupport_fastrtps_c.h"
...
using _GetSafetyMode_Request__ros_msg_type = aubo_dashboard_msgs__srv__GetSafetyMode_Request;
...
size_t get_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetSafetyMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Request(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_GetSafetyMode_Request = {
  "aubo_dashboard_msgs::srv",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetSafetyMode_Request)() {
...
#include "aubo_dashboard_msgs/msg/detail/safety_mode__functions.h"  // safety_mode
#include "rosidl_runtime_c/string.h"  // answer
#include "rosidl_runtime_c/string_functions.h"  // answer

// forward declare type support functions
size_t get_serialized_size_aubo_dashboard_msgs__msg__SafetyMode(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_aubo_dashboard_msgs__msg__SafetyMode(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, SafetyMode)();


using _GetSafetyMode_Response__ros_msg_type = aubo_dashboard_msgs__srv__GetSafetyMode_Response;
  ...
  // Field name: safety_mode
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, msg, SafetyMode
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSafetyMode_Response__ros_msg_type * ros_message = static_cast<const _GetSafetyMode_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_aubo_dashboard_msgs__msg__SafetyMode(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: safety_mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_aubo_dashboard_msgs__msg__SafetyMode(
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__GetSafetyMode_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetSafetyMode_Response)() {
...
// already included above
// #include "aubo_dashboard_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_dashboard_msgs/srv/get_safety_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, GetSafetyMode)() {

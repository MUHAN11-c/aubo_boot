...
#include "aubo_dashboard_msgs/srv/detail/is_program_running__rosidl_typesupport_fastrtps_c.h"
...
using _IsProgramRunning_Request__ros_msg_type = aubo_dashboard_msgs__srv__IsProgramRunning_Request;
...
size_t get_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Request(
  const void * untyped_ros_message,
...
static uint32_t _IsProgramRunning_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, IsProgramRunning_Request)() {
...
using _IsProgramRunning_Response__ros_msg_type = aubo_dashboard_msgs__srv__IsProgramRunning_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IsProgramRunning_Response__ros_msg_type * ros_message = static_cast<const _IsProgramRunning_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__IsProgramRunning_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, IsProgramRunning_Response)() {
...
// already included above
// #include "aubo_dashboard_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_dashboard_msgs/srv/is_program_running.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, IsProgramRunning)() {

...
#include "aubo_dashboard_msgs/srv/detail/is_program_saved__rosidl_typesupport_fastrtps_c.h"
...
using _IsProgramSaved_Request__ros_msg_type = aubo_dashboard_msgs__srv__IsProgramSaved_Request;
...
size_t get_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Request(
  const void * untyped_ros_message,
...
static uint32_t _IsProgramSaved_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, IsProgramSaved_Request)() {
...
using _IsProgramSaved_Response__ros_msg_type = aubo_dashboard_msgs__srv__IsProgramSaved_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t get_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IsProgramSaved_Response__ros_msg_type * ros_message = static_cast<const _IsProgramSaved_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_dashboard_msgs
size_t max_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_dashboard_msgs__srv__IsProgramSaved_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, IsProgramSaved_Response)() {
...
// already included above
// #include "aubo_dashboard_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_dashboard_msgs/srv/is_program_saved.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_dashboard_msgs, srv, IsProgramSaved)() {

...
#include "aubo_dashboard_msgs/msg/detail/program_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_dashboard_msgs::msg::ProgramState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_dashboard_msgs::msg::ProgramState & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::msg::ProgramState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::msg::ProgramState *>(
    untyped_ros_message);
...
{
  return &aubo_dashboard_msgs::msg::typesupport_fastrtps_cpp::_ProgramState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, msg, ProgramState)() {
  return &aubo_dashboard_msgs::msg::typesupport_fastrtps_cpp::_ProgramState__handle;
}

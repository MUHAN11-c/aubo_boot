...
#include "aubo_dashboard_msgs/srv/detail/add_to_log__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_dashboard_msgs::srv::AddToLog_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_dashboard_msgs::srv::AddToLog_Request & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::srv::AddToLog_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::srv::AddToLog_Request *>(
    untyped_ros_message);
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_AddToLog_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, srv, AddToLog_Request)() {
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_AddToLog_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aubo_dashboard_msgs
cdr_serialize(
  const aubo_dashboard_msgs::srv::AddToLog_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: answer
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_dashboard_msgs::srv::AddToLog_Response & ros_message)
{
  // Member: answer
  cdr >> ros_message.answer;
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::srv::AddToLog_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::srv::AddToLog_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_AddToLog_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, srv, AddToLog_Response)() {
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_AddToLog_Response__handle;
}
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_AddToLog__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, srv, AddToLog)() {
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_AddToLog__handle;
}

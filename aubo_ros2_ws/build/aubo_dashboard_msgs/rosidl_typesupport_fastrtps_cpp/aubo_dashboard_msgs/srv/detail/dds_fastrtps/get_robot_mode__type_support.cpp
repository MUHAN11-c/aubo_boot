...
#include "aubo_dashboard_msgs/srv/detail/get_robot_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_dashboard_msgs::srv::GetRobotMode_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_dashboard_msgs::srv::GetRobotMode_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::srv::GetRobotMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::srv::GetRobotMode_Request *>(
    untyped_ros_message);
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_GetRobotMode_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, srv, GetRobotMode_Request)() {
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_GetRobotMode_Request__handle;
}
...
{
bool cdr_serialize(
  const aubo_dashboard_msgs::msg::RobotMode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  aubo_dashboard_msgs::msg::RobotMode &);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aubo_dashboard_msgs
cdr_serialize(
  const aubo_dashboard_msgs::srv::GetRobotMode_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: robot_mode
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_dashboard_msgs::srv::GetRobotMode_Response & ros_message)
{
  // Member: robot_mode
  ...
  size_t current_alignment)
{
  ...
  // Member: robot_mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aubo_dashboard_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotMode(
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::srv::GetRobotMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::srv::GetRobotMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_GetRobotMode_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, srv, GetRobotMode_Response)() {
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_GetRobotMode_Response__handle;
}
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_GetRobotMode__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_dashboard_msgs, srv, GetRobotMode)() {
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_GetRobotMode__handle;
}

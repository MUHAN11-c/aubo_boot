...
#include "aubo_dashboard_msgs/srv/detail/is_program_saved__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::srv::IsProgramSaved_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::srv::IsProgramSaved_Request *>(
    untyped_ros_message);
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_IsProgramSaved_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const aubo_dashboard_msgs::srv::IsProgramSaved_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aubo_dashboard_msgs::srv::IsProgramSaved_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_IsProgramSaved_Response__handle;
}
...
{
  return &aubo_dashboard_msgs::srv::typesupport_fastrtps_cpp::_IsProgramSaved__handle;
}

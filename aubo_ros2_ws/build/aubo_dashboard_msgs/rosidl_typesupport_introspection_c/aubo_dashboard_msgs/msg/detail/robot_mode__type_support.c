  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  aubo_dashboard_msgs__msg__RobotMode__init(message_memory);
}

void RobotMode__rosidl_typesupport_introspection_c__RobotMode_fini_function(void * message_memory)
{
  aubo_dashboard_msgs__msg__RobotMode__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RobotMode__rosidl_typesupport_introspection_c__RobotMode_message_member_array[1] = {
  {
    ...
    offsetof(aubo_dashboard_msgs__msg__RobotMode, mode),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotMode__rosidl_typesupport_introspection_c__RobotMode_message_members = {
  ...
  1,  // number of fields
  sizeof(aubo_dashboard_msgs__msg__RobotMode),

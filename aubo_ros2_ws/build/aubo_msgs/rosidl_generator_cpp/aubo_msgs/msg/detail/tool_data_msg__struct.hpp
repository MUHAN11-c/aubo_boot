...
#ifndef AUBO_MSGS__MSG__DETAIL__TOOL_DATA_MSG__STRUCT_HPP_
#define AUBO_MSGS__MSG__DETAIL__TOOL_DATA_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__aubo_msgs__msg__ToolDataMsg __attribute__((deprecated))
#else
# define DEPRECATED__aubo_msgs__msg__ToolDataMsg __declspec(deprecated)
#endif
...
struct ToolDataMsg_
{
  ...
  // pointer types
  using RawPtr =
    aubo_msgs::msg::ToolDataMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const aubo_msgs::msg::ToolDataMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      aubo_msgs::msg::ToolDataMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__aubo_msgs__msg__ToolDataMsg
    std::shared_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__aubo_msgs__msg__ToolDataMsg
    std::shared_ptr<aubo_msgs::msg::ToolDataMsg_<ContainerAllocator> const>
...
using ToolDataMsg =
  aubo_msgs::msg::ToolDataMsg_<std::allocator<void>>;
...
#endif  // AUBO_MSGS__MSG__DETAIL__TOOL_DATA_MSG__STRUCT_HPP_

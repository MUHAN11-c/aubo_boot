...
bool aubo_msgs__msg__robot_mode_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aubo_msgs.msg._robot_mode_data_msg.RobotModeDataMsg", full_classname_dest, 51) == 0);
  }
  aubo_msgs__msg__RobotModeDataMsg * ros_message = _ros_message;
  {  // timestamp
...
PyObject * aubo_msgs__msg__robot_mode_data_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aubo_msgs.msg._robot_mode_data_msg");

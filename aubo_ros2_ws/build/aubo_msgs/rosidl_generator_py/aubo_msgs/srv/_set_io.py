...
class Metaclass_SetIO(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_msgs.srv import _set_io
...
class SetIO(metaclass=Metaclass_SetIO):
    from aubo_msgs.srv._set_io import SetIO_Request as Request
    from aubo_msgs.srv._set_io import SetIO_Response as Response

...
static const _MasterboardDataMsg_type_support_symbol_names_t _MasterboardDataMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, msg, MasterboardDataMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, msg, MasterboardDataMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_msgs, msg, MasterboardDataMsg)() {
  return &::aubo_msgs::msg::rosidl_typesupport_c::MasterboardDataMsg_message_type_support_handle;
}

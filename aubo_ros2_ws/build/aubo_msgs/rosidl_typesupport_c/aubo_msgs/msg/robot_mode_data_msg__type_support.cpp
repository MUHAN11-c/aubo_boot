...
static const _RobotModeDataMsg_type_support_symbol_names_t _RobotModeDataMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, msg, RobotModeDataMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, msg, RobotModeDataMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_msgs, msg, RobotModeDataMsg)() {
  return &::aubo_msgs::msg::rosidl_typesupport_c::RobotModeDataMsg_message_type_support_handle;
}

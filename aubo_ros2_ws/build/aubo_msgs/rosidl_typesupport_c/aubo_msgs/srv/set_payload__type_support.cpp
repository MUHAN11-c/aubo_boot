...
static const _SetPayload_Request_type_support_symbol_names_t _SetPayload_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetPayload_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_msgs, srv, SetPayload_Request)() {
  return &::aubo_msgs::srv::rosidl_typesupport_c::SetPayload_Request_message_type_support_handle;
}
...
static const _SetPayload_Response_type_support_symbol_names_t _SetPayload_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetPayload_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_aubo_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aubo_msgs, srv, SetPayload_Response)() {
  return &::aubo_msgs::srv::rosidl_typesupport_c::SetPayload_Response_message_type_support_handle;
}
...
static const _SetPayload_type_support_symbol_names_t _SetPayload_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetPayload)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aubo_msgs, srv, SetPayload)() {
  return &::aubo_msgs::srv::rosidl_typesupport_c::SetPayload_service_type_support_handle;
}

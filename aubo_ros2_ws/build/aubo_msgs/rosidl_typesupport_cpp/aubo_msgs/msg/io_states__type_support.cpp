...
static const _IOStates_type_support_symbol_names_t _IOStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, msg, IOStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aubo_msgs, msg, IOStates)),
  }
};
...
{
  return &::aubo_msgs::msg::rosidl_typesupport_cpp::IOStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aubo_msgs, msg, IOStates)() {
  return get_message_type_support_handle<aubo_msgs::msg::IOStates>();
}

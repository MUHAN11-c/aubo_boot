...
#include "aubo_msgs/msg/detail/analog__rosidl_typesupport_fastrtps_c.h"
...
using _Analog__ros_msg_type = aubo_msgs__msg__Analog;
...
static uint32_t _Analog__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__msg__Analog(
...
{
  return max_serialized_size_aubo_msgs__msg__Analog(
    full_bounded, 0);
}

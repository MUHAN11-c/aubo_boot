...
#include "aubo_msgs/msg/detail/digital__rosidl_typesupport_fastrtps_c.h"
...
using _Digital__ros_msg_type = aubo_msgs__msg__Digital;
...
static uint32_t _Digital__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__msg__Digital(
...
{
  return max_serialized_size_aubo_msgs__msg__Digital(
    full_bounded, 0);
}

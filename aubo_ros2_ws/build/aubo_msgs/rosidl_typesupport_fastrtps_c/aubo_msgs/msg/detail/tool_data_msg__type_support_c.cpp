...
#include "aubo_msgs/msg/detail/tool_data_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ToolDataMsg__ros_msg_type = aubo_msgs__msg__ToolDataMsg;
...
size_t get_serialized_size_aubo_msgs__msg__ToolDataMsg(
  const void * untyped_ros_message,
...
static uint32_t _ToolDataMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__msg__ToolDataMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t max_serialized_size_aubo_msgs__msg__ToolDataMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_msgs__msg__ToolDataMsg(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, msg, ToolDataMsg)() {

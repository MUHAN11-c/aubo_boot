...
#include "aubo_msgs/srv/detail/set_payload__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_aubo_msgs
...
using _SetPayload_Request__ros_msg_type = aubo_msgs__srv__SetPayload_Request;
...
size_t get_serialized_size_aubo_msgs__srv__SetPayload_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPayload_Request__ros_msg_type * ros_message = static_cast<const _SetPayload_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetPayload_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__srv__SetPayload_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t max_serialized_size_aubo_msgs__srv__SetPayload_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_msgs__srv__SetPayload_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetPayload_Request)() {
...
using _SetPayload_Response__ros_msg_type = aubo_msgs__srv__SetPayload_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t get_serialized_size_aubo_msgs__srv__SetPayload_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPayload_Response__ros_msg_type * ros_message = static_cast<const _SetPayload_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__srv__SetPayload_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t max_serialized_size_aubo_msgs__srv__SetPayload_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_msgs__srv__SetPayload_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetPayload_Response)() {
...
// already included above
// #include "aubo_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_msgs/srv/set_payload.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetPayload)() {

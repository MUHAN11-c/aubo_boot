...
#include "aubo_msgs/srv/detail/set_speed_slider_fraction__rosidl_typesupport_fastrtps_c.h"
...
using _SetSpeedSliderFraction_Request__ros_msg_type = aubo_msgs__srv__SetSpeedSliderFraction_Request;
...
size_t get_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetSpeedSliderFraction_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t max_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetSpeedSliderFraction_Request)() {
...
using _SetSpeedSliderFraction_Response__ros_msg_type = aubo_msgs__srv__SetSpeedSliderFraction_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t get_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetSpeedSliderFraction_Response__ros_msg_type * ros_message = static_cast<const _SetSpeedSliderFraction_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aubo_msgs
size_t max_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aubo_msgs__srv__SetSpeedSliderFraction_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetSpeedSliderFraction_Response)() {
...
// already included above
// #include "aubo_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "aubo_msgs/srv/set_speed_slider_fraction.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aubo_msgs, srv, SetSpeedSliderFraction)() {

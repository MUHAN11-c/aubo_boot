...
#include "aubo_msgs/msg/detail/analog__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_msgs::msg::Analog & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::msg::Analog & ros_message)
{
  // Member: pin
  cdr >> ros_message.pin;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::msg::Analog *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::msg::Analog *>(
    untyped_ros_message);
...
{
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_Analog__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, msg, Analog)() {
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_Analog__handle;
}

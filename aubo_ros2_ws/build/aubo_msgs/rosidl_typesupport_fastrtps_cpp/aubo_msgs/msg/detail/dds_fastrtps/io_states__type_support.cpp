...
#include "aubo_msgs/msg/detail/io_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aubo_msgs::msg::Digital &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  aubo_msgs::msg::Digital &);
...
{
bool cdr_serialize(
  const aubo_msgs::msg::Analog &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  aubo_msgs::msg::Analog &);
size_t get_serialized_size(
  const aubo_msgs::msg::Analog &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const aubo_msgs::msg::IOStates & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: digital_in_states
  {
    ...
    for (size_t i = 0; i < size; i++) {
      aubo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::msg::IOStates & ros_message)
{
  // Member: digital_in_states
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      aubo_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: digital_in_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aubo_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: digital_in_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aubo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Digital(
  ...
  // Member: analog_in_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aubo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Analog(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const aubo_msgs::msg::IOStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::msg::IOStates *>(
    untyped_ros_message);
...
{
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_IOStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, msg, IOStates)() {
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_IOStates__handle;
}

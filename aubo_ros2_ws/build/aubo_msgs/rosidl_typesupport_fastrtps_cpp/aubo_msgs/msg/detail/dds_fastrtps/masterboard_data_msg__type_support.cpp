...
#include "aubo_msgs/msg/detail/masterboard_data_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_msgs::msg::MasterboardDataMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::msg::MasterboardDataMsg & ros_message)
{
  // Member: digital_input_bits
  cdr >> ros_message.digital_input_bits;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::msg::MasterboardDataMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::msg::MasterboardDataMsg *>(
    untyped_ros_message);
...
{
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_MasterboardDataMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, msg, MasterboardDataMsg)() {
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_MasterboardDataMsg__handle;
}

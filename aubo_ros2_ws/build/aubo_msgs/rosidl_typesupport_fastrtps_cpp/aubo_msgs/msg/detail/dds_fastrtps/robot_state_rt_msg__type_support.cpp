...
#include "aubo_msgs/msg/detail/robot_state_rt_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_msgs::msg::RobotStateRTMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::msg::RobotStateRTMsg & ros_message)
{
  // Member: time
  cdr >> ros_message.time;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::msg::RobotStateRTMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::msg::RobotStateRTMsg *>(
    untyped_ros_message);
...
{
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_RobotStateRTMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, msg, RobotStateRTMsg)() {
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_RobotStateRTMsg__handle;
}

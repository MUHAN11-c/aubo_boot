...
#include "aubo_msgs/msg/detail/tool_data_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_msgs::msg::ToolDataMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::msg::ToolDataMsg & ros_message)
{
  // Member: analog_input_range2
  cdr >> ros_message.analog_input_range2;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::msg::ToolDataMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::msg::ToolDataMsg *>(
    untyped_ros_message);
...
{
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_ToolDataMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, msg, ToolDataMsg)() {
  return &aubo_msgs::msg::typesupport_fastrtps_cpp::_ToolDataMsg__handle;
}

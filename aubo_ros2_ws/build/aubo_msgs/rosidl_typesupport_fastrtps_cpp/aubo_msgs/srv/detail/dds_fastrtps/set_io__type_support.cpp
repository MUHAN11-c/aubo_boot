...
#include "aubo_msgs/srv/detail/set_io__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aubo_msgs::srv::SetIO_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::srv::SetIO_Request & ros_message)
{
  // Member: fun
  cdr >> ros_message.fun;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::srv::SetIO_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::srv::SetIO_Request *>(
    untyped_ros_message);
...
{
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, srv, SetIO_Request)() {
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aubo_msgs
cdr_serialize(
  const aubo_msgs::srv::SetIO_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::srv::SetIO_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::srv::SetIO_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aubo_msgs::srv::SetIO_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, srv, SetIO_Response)() {
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Response__handle;
}
...
{
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetIO__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, srv, SetIO)() {
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetIO__handle;
}

...
#include "aubo_msgs/srv/detail/set_speed_slider_fraction__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aubo_msgs
cdr_serialize(
  const aubo_msgs::srv::SetSpeedSliderFraction_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::srv::SetSpeedSliderFraction_Request & ros_message)
{
  // Member: speed_slider_fraction
  cdr >> ros_message.speed_slider_fraction;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::srv::SetSpeedSliderFraction_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aubo_msgs::srv::SetSpeedSliderFraction_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_aubo_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<aubo_msgs::srv::SetSpeedSliderFraction_Request>()
{
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetSpeedSliderFraction_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, srv, SetSpeedSliderFraction_Request)() {
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetSpeedSliderFraction_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aubo_msgs
cdr_serialize(
  const aubo_msgs::srv::SetSpeedSliderFraction_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aubo_msgs::srv::SetSpeedSliderFraction_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const aubo_msgs::srv::SetSpeedSliderFraction_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aubo_msgs::srv::SetSpeedSliderFraction_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetSpeedSliderFraction_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, srv, SetSpeedSliderFraction_Response)() {
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetSpeedSliderFraction_Response__handle;
}
...
{
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetSpeedSliderFraction__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aubo_msgs, srv, SetSpeedSliderFraction)() {
  return &aubo_msgs::srv::typesupport_fastrtps_cpp::_SetSpeedSliderFraction__handle;
}

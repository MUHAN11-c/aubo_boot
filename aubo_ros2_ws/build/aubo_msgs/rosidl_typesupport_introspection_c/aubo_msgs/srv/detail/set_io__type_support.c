...
#include <stddef.h>
#include "aubo_msgs/srv/detail/set_io__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember SetIO_Request__rosidl_typesupport_introspection_c__SetIO_Request_message_member_array[3] = {
  {
    ...
    offsetof(aubo_msgs__srv__SetIO_Request, fun),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs__srv__SetIO_Request, pin),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs__srv__SetIO_Request, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetIO_Request__rosidl_typesupport_introspection_c__SetIO_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(aubo_msgs__srv__SetIO_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetIO_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember SetIO_Response__rosidl_typesupport_introspection_c__SetIO_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs__srv__SetIO_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetIO_Response__rosidl_typesupport_introspection_c__SetIO_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(aubo_msgs__srv__SetIO_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_aubo_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetIO_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_members = {
  "aubo_msgs__srv",  // service namespace
  "SetIO",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_Request_message_type_support_handle,
  NULL  // response message
  // aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_Response_message_type_support_handle
};

static rosidl_service_type_support_t aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle = {
  0,
  &aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetIO)() {
  if (!aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle.typesupport_identifier) {
    aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetIO_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetIO_Response)()->data;
  }

  return &aubo_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle;
}

...
{
  new (message_memory) aubo_msgs::msg::Digital(_init);
}

void Digital_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aubo_msgs::msg::Digital *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Digital_message_member_array[2] = {
  {
    ...
    offsetof(aubo_msgs::msg::Digital, pin),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::Digital, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<aubo_msgs::msg::Digital>()
{
  return &::aubo_msgs::msg::rosidl_typesupport_introspection_cpp::Digital_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aubo_msgs, msg, Digital)() {
  return &::aubo_msgs::msg::rosidl_typesupport_introspection_cpp::Digital_message_type_support_handle;
}

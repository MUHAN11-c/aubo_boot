...
#define NODE_MAIN_LOGGER_NAME "percipio_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpercipio_camera.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<percipio_camera::PercipioCameraNodeDriver>";

...
#include <stddef.h>
#include "aubo_dashboard_msgs/srv/detail/raw_request__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  aubo_dashboard_msgs__srv__RawRequest_Request__init(message_memory);
}

void RawRequest_Request__rosidl_typesupport_introspection_c__RawRequest_Request_fini_function(void * message_memory)
{
  aubo_dashboard_msgs__srv__RawRequest_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RawRequest_Request__rosidl_typesupport_introspection_c__RawRequest_Request_message_member_array[1] = {
  {
    ...
    offsetof(aubo_dashboard_msgs__srv__RawRequest_Request, query),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers RawRequest_Request__rosidl_typesupport_introspection_c__RawRequest_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(aubo_dashboard_msgs__srv__RawRequest_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  aubo_dashboard_msgs__srv__RawRequest_Response__init(message_memory);
}

void RawRequest_Response__rosidl_typesupport_introspection_c__RawRequest_Response_fini_function(void * message_memory)
{
  aubo_dashboard_msgs__srv__RawRequest_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RawRequest_Response__rosidl_typesupport_introspection_c__RawRequest_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_dashboard_msgs__srv__RawRequest_Response, answer),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RawRequest_Response__rosidl_typesupport_introspection_c__RawRequest_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(aubo_dashboard_msgs__srv__RawRequest_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_aubo_dashboard_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_members = {
  "aubo_dashboard_msgs__srv",  // service namespace
  "RawRequest",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_Request_message_type_support_handle,
  NULL  // response message
  // aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_Response_message_type_support_handle
};

static rosidl_service_type_support_t aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_type_support_handle = {
  0,
  &aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest)() {
  if (!aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_type_support_handle.typesupport_identifier) {
    aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_dashboard_msgs, srv, RawRequest_Response)()->data;
  }

  return &aubo_dashboard_msgs__srv__detail__raw_request__rosidl_typesupport_introspection_c__RawRequest_service_type_support_handle;
}

...
class Metaclass_GetLoadedProgram(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.srv.GetLoadedProgram')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.srv import _get_loaded_program
...
class GetLoadedProgram(metaclass=Metaclass_GetLoadedProgram):
    from aubo_dashboard_msgs.srv._get_loaded_program import GetLoadedProgram_Request as Request
    from aubo_dashboard_msgs.srv._get_loaded_program import GetLoadedProgram_Response as Response

...
class Metaclass_GetRobotMode_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_dashboard_msgs.msg import RobotMode
...
class GetRobotMode_Response(metaclass=Metaclass_GetRobotMode_Response):
    ...
    _fields_and_field_types = {
        'robot_mode': 'aubo_dashboard_msgs/RobotMode',
        'answer': 'string',
        'success': 'boolean',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['aubo_dashboard_msgs', 'msg'], 'RobotMode'),  # noqa: E501
...
class Metaclass_GetRobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.srv.GetRobotMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.srv import _get_robot_mode
...
class GetRobotMode(metaclass=Metaclass_GetRobotMode):
    from aubo_dashboard_msgs.srv._get_robot_mode import GetRobotMode_Request as Request
    from aubo_dashboard_msgs.srv._get_robot_mode import GetRobotMode_Response as Response

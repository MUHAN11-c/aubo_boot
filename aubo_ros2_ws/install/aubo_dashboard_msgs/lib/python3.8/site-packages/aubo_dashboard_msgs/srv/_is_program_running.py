...
class Metaclass_IsProgramRunning(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_dashboard_msgs.srv.IsProgramRunning')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_dashboard_msgs.srv import _is_program_running
...
class IsProgramRunning(metaclass=Metaclass_IsProgramRunning):
    from aubo_dashboard_msgs.srv._is_program_running import IsProgramRunning_Request as Request
    from aubo_dashboard_msgs.srv._is_program_running import IsProgramRunning_Response as Response

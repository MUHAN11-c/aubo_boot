...
class Metaclass_Popup(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_dashboard_msgs.srv import _popup
...
class Popup(metaclass=Metaclass_Popup):
    from aubo_dashboard_msgs.srv._popup import Popup_Request as Request
    from aubo_dashboard_msgs.srv._popup import Popup_Response as Response

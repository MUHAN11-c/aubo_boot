...
{
  new (message_memory) aubo_msgs::msg::Analog(_init);
}

void Analog_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aubo_msgs::msg::Analog *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Analog_message_member_array[3] = {
  {
    ...
    offsetof(aubo_msgs::msg::Analog, pin),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::Analog, domain),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::Analog, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<aubo_msgs::msg::Analog>()
{
  return &::aubo_msgs::msg::rosidl_typesupport_introspection_cpp::Analog_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aubo_msgs, msg, Analog)() {
  return &::aubo_msgs::msg::rosidl_typesupport_introspection_cpp::Analog_message_type_support_handle;
}

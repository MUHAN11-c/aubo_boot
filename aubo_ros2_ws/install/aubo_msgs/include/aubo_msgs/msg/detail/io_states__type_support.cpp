...
{
  new (message_memory) aubo_msgs::msg::IOStates(_init);
}

void IOStates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aubo_msgs::msg::IOStates *>(message_memory);
  typed_message->~IOStates();
}

size_t size_function__IOStates__digital_in_states(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<aubo_msgs::msg::Digital> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<aubo_msgs::msg::Digital> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<aubo_msgs::msg::Digital> *>(untyped_member);
  return &member[index];
}
...
{
  const auto * member = reinterpret_cast<const std::vector<aubo_msgs::msg::Analog> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<aubo_msgs::msg::Analog> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<aubo_msgs::msg::Analog> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IOStates_message_member_array[5] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<aubo_msgs::msg::Digital>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::IOStates, digital_in_states),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::IOStates, digital_out_states),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::IOStates, flag_states),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<aubo_msgs::msg::Analog>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::IOStates, analog_in_states),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs::msg::IOStates, analog_out_states),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<aubo_msgs::msg::IOStates>()
{
  return &::aubo_msgs::msg::rosidl_typesupport_introspection_cpp::IOStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aubo_msgs, msg, IOStates)() {
  return &::aubo_msgs::msg::rosidl_typesupport_introspection_cpp::IOStates_message_type_support_handle;
}

...
bool
aubo_msgs__msg__RobotStateRTMsg__init(aubo_msgs__msg__RobotStateRTMsg * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__double__Sequence__init(&msg->q_target, 0)) {
    aubo_msgs__msg__RobotStateRTMsg__fini(msg);
    return false;
  }
  // qd_target
...
void
aubo_msgs__msg__RobotStateRTMsg__fini(aubo_msgs__msg__RobotStateRTMsg * msg)
{
  if (!msg) {
    return;
  }
...
bool
aubo_msgs__msg__RobotStateRTMsg__are_equal(const aubo_msgs__msg__RobotStateRTMsg * lhs, const aubo_msgs__msg__RobotStateRTMsg * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
aubo_msgs__msg__RobotStateRTMsg__copy(
  const aubo_msgs__msg__RobotStateRTMsg * input,
  aubo_msgs__msg__RobotStateRTMsg * output)
{
  if (!input || !output) {
    return false;
  }
...
aubo_msgs__msg__RobotStateRTMsg *
aubo_msgs__msg__RobotStateRTMsg__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aubo_msgs__msg__RobotStateRTMsg * msg = (aubo_msgs__msg__RobotStateRTMsg *)allocator.allocate(sizeof(aubo_msgs__msg__RobotStateRTMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aubo_msgs__msg__RobotStateRTMsg));
  bool success = aubo_msgs__msg__RobotStateRTMsg__init(msg);
  if (!success) {
...
void
aubo_msgs__msg__RobotStateRTMsg__destroy(aubo_msgs__msg__RobotStateRTMsg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aubo_msgs__msg__RobotStateRTMsg__fini(msg);
...
bool
aubo_msgs__msg__RobotStateRTMsg__Sequence__init(aubo_msgs__msg__RobotStateRTMsg__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aubo_msgs__msg__RobotStateRTMsg * data = NULL;

  if (size) {
    data = (aubo_msgs__msg__RobotStateRTMsg *)allocator.zero_allocate(size, sizeof(aubo_msgs__msg__RobotStateRTMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = aubo_msgs__msg__RobotStateRTMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        aubo_msgs__msg__RobotStateRTMsg__fini(&data[i - 1]);
      }
...
void
aubo_msgs__msg__RobotStateRTMsg__Sequence__fini(aubo_msgs__msg__RobotStateRTMsg__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aubo_msgs__msg__RobotStateRTMsg__fini(&array->data[i]);
    }
...
aubo_msgs__msg__RobotStateRTMsg__Sequence *
aubo_msgs__msg__RobotStateRTMsg__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aubo_msgs__msg__RobotStateRTMsg__Sequence * array = (aubo_msgs__msg__RobotStateRTMsg__Sequence *)allocator.allocate(sizeof(aubo_msgs__msg__RobotStateRTMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = aubo_msgs__msg__RobotStateRTMsg__Sequence__init(array, size);
  if (!success) {
...
void
aubo_msgs__msg__RobotStateRTMsg__Sequence__destroy(aubo_msgs__msg__RobotStateRTMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aubo_msgs__msg__RobotStateRTMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
aubo_msgs__msg__RobotStateRTMsg__Sequence__are_equal(const aubo_msgs__msg__RobotStateRTMsg__Sequence * lhs, const aubo_msgs__msg__RobotStateRTMsg__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aubo_msgs__msg__RobotStateRTMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
aubo_msgs__msg__RobotStateRTMsg__Sequence__copy(
  const aubo_msgs__msg__RobotStateRTMsg__Sequence * input,
  aubo_msgs__msg__RobotStateRTMsg__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(aubo_msgs__msg__RobotStateRTMsg);
    aubo_msgs__msg__RobotStateRTMsg * data =
      (aubo_msgs__msg__RobotStateRTMsg *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aubo_msgs__msg__RobotStateRTMsg__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          aubo_msgs__msg__RobotStateRTMsg__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aubo_msgs__msg__RobotStateRTMsg__copy(

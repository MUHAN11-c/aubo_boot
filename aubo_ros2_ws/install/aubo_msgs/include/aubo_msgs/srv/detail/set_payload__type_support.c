...
#include <stddef.h>
#include "aubo_msgs/srv/detail/set_payload__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember SetPayload_Request__rosidl_typesupport_introspection_c__SetPayload_Request_message_member_array[2] = {
  {
    ...
    offsetof(aubo_msgs__srv__SetPayload_Request, mass),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs__srv__SetPayload_Request, center_of_gravity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPayload_Request__rosidl_typesupport_introspection_c__SetPayload_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(aubo_msgs__srv__SetPayload_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember SetPayload_Response__rosidl_typesupport_introspection_c__SetPayload_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs__srv__SetPayload_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPayload_Response__rosidl_typesupport_introspection_c__SetPayload_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(aubo_msgs__srv__SetPayload_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_aubo_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_members = {
  "aubo_msgs__srv",  // service namespace
  "SetPayload",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_Request_message_type_support_handle,
  NULL  // response message
  // aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_Response_message_type_support_handle
};

static rosidl_service_type_support_t aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_type_support_handle = {
  0,
  &aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload)() {
  if (!aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_type_support_handle.typesupport_identifier) {
    aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetPayload_Response)()->data;
  }

  return &aubo_msgs__srv__detail__set_payload__rosidl_typesupport_introspection_c__SetPayload_service_type_support_handle;
}

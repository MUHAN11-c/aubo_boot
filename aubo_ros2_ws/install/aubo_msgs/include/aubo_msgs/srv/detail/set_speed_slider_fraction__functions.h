...
#ifndef AUBO_MSGS__SRV__DETAIL__SET_SPEED_SLIDER_FRACTION__FUNCTIONS_H_
#define AUBO_MSGS__SRV__DETAIL__SET_SPEED_SLIDER_FRACTION__FUNCTIONS_H_
 ...
 * calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Request__init().
...
/**
 * It calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Request__fini()
 ...
 * aubo_msgs__srv__SetSpeedSliderFraction_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aubo_msgs
...
/**
 * It calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aubo_msgs
...
/**
 * It allocates the memory for the array and calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aubo_msgs
...
/**
 * It calls
 * aubo_msgs__srv__SetSpeedSliderFraction_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUBO_MSGS__SRV__DETAIL__SET_SPEED_SLIDER_FRACTION__FUNCTIONS_H_

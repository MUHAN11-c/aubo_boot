...
#include <stddef.h>
#include "aubo_msgs/srv/detail/set_speed_slider_fraction__rosidl_typesupport_introspection_c.h"
#include "aubo_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  aubo_msgs__srv__SetSpeedSliderFraction_Request__init(message_memory);
}
...
{
  aubo_msgs__srv__SetSpeedSliderFraction_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetSpeedSliderFraction_Request__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_Request_message_member_array[1] = {
  {
    ...
    offsetof(aubo_msgs__srv__SetSpeedSliderFraction_Request, speed_slider_fraction),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers SetSpeedSliderFraction_Request__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_Request_message_members = {
  "aubo_msgs__srv",  // message namespace
  "SetSpeedSliderFraction_Request",  // message name
  1,  // number of fields
  sizeof(aubo_msgs__srv__SetSpeedSliderFraction_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_aubo_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetSpeedSliderFraction_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  aubo_msgs__srv__SetSpeedSliderFraction_Response__init(message_memory);
}
...
{
  aubo_msgs__srv__SetSpeedSliderFraction_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetSpeedSliderFraction_Response__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aubo_msgs__srv__SetSpeedSliderFraction_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetSpeedSliderFraction_Response__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(aubo_msgs__srv__SetSpeedSliderFraction_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_aubo_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetSpeedSliderFraction_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_members = {
  "aubo_msgs__srv",  // service namespace
  "SetSpeedSliderFraction",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_Request_message_type_support_handle,
  NULL  // response message
  // aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_Response_message_type_support_handle
};

static rosidl_service_type_support_t aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_type_support_handle = {
  0,
  &aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetSpeedSliderFraction)() {
  if (!aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_type_support_handle.typesupport_identifier) {
    aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetSpeedSliderFraction_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aubo_msgs, srv, SetSpeedSliderFraction_Response)()->data;
  }

  return &aubo_msgs__srv__detail__set_speed_slider_fraction__rosidl_typesupport_introspection_c__SetSpeedSliderFraction_service_type_support_handle;
}

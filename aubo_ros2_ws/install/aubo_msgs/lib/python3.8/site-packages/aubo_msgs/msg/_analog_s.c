...
bool aubo_msgs__msg__analog__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aubo_msgs.msg._analog.Analog", full_classname_dest, 28) == 0);
  }
  aubo_msgs__msg__Analog * ros_message = _ros_message;
  {  // pin
...
PyObject * aubo_msgs__msg__analog__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aubo_msgs.msg._analog");

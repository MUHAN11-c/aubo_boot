...
class Metaclass_IOStates(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('aubo_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'aubo_msgs.msg.IOStates')
            logger.debug(
...
class IOStates(metaclass=Metaclass_IOStates):
    ...
    _fields_and_field_types = {
        'digital_in_states': 'sequence<aubo_msgs/Digital>',
        'digital_out_states': 'sequence<aubo_msgs/Digital>',
        'flag_states': 'sequence<aubo_msgs/Digital>',
        'analog_in_states': 'sequence<aubo_msgs/Analog>',
        'analog_out_states': 'sequence<aubo_msgs/Analog>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aubo_msgs', 'msg'], 'Digital')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aubo_msgs', 'msg'], 'Digital')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aubo_msgs', 'msg'], 'Digital')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aubo_msgs', 'msg'], 'Analog')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aubo_msgs', 'msg'], 'Analog')),  # noqa: E501
    )

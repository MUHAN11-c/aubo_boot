...
bool aubo_msgs__msg__masterboard_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aubo_msgs.msg._masterboard_data_msg.MasterboardDataMsg", full_classname_dest, 54) == 0);
  }
  aubo_msgs__msg__MasterboardDataMsg * ros_message = _ros_message;
  {  // digital_input_bits
...
PyObject * aubo_msgs__msg__masterboard_data_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aubo_msgs.msg._masterboard_data_msg");

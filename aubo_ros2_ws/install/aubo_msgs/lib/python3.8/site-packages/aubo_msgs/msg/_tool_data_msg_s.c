...
bool aubo_msgs__msg__tool_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aubo_msgs.msg._tool_data_msg.ToolDataMsg", full_classname_dest, 40) == 0);
  }
  aubo_msgs__msg__ToolDataMsg * ros_message = _ros_message;
  {  // analog_input_range2
...
PyObject * aubo_msgs__msg__tool_data_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aubo_msgs.msg._tool_data_msg");

...
class Metaclass_SetPayload(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aubo_msgs.srv import _set_payload
...
class SetPayload(metaclass=Metaclass_SetPayload):
    from aubo_msgs.srv._set_payload import SetPayload_Request as Request
    from aubo_msgs.srv._set_payload import SetPayload_Response as Response

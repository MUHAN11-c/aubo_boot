...
class Metaclass_SetSpeedSliderFraction(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aubo_msgs.srv.SetSpeedSliderFraction')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aubo_msgs.srv import _set_speed_slider_fraction
...
class SetSpeedSliderFraction(metaclass=Metaclass_SetSpeedSliderFraction):
    from aubo_msgs.srv._set_speed_slider_fraction import SetSpeedSliderFraction_Request as Request
    from aubo_msgs.srv._set_speed_slider_fraction import SetSpeedSliderFraction_Response as Response

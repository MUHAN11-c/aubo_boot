...
public:
  ...
  template <class T>
  void setAndGetNodeParameter(T& param, const std::string& param_name, const T& default_value,
  ...
  std::shared_ptr<PercipioDevice> Device() const
  {
    return device_ptr;
  }
...
private:
  ...
  std::map<percipio_stream_index_pair, rclcpp::Publisher<sensor_msgs::msg::CameraInfo>::SharedPtr>

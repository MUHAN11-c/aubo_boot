...
#include "ivg_interfaces/srv/set_camera_parameters.hpp"
#include "ivg_interfaces/srv/software_trigger.hpp"
...
public:
        ...
        : Node("camera_control_node")
    {
        ...
        // 创建状态发布器
        status_pub_ = this->create_publisher<ivg_interfaces::msg::CameraStatus>(
            "camera_status", 10);
        
        // 创建服务端
        set_params_srv_ = this->create_service<ivg_interfaces::srv::SetCameraParameters>(
        ...
        software_trigger_srv_ = this->create_service<ivg_interfaces::srv::SoftwareTrigger>(
            "software_trigger",
        ...
        RCLCPP_INFO(this->get_logger(), "  服务类型: ivg_interfaces/srv/SoftwareTrigger");
...
private:
    ...
    void publishStatus()
    {
        ...
        auto status_msg = ivg_interfaces::msg::CameraStatus();
    ...
    void setCameraParametersCallback(
        const std::shared_ptr<ivg_interfaces::srv::SetCameraParameters::Request> request,
        std::shared_ptr<ivg_interfaces::srv::SetCameraParameters::Response> response)
    {
    ...
    void softwareTriggerCallback(
        const std::shared_ptr<ivg_interfaces::srv::SoftwareTrigger::Request> request,
        std::shared_ptr<ivg_interfaces::srv::SoftwareTrigger::Response> response)
    {
        response->success = false;
        response->message = "";
    ...
    rclcpp::Publisher<ivg_interfaces::msg::CameraStatus>::SharedPtr status_pub_;
    rclcpp::Service<ivg_interfaces::srv::SetCameraParameters>::SharedPtr set_params_srv_;
    rclcpp::Service<ivg_interfaces::srv::SoftwareTrigger>::SharedPtr software_trigger_srv_;

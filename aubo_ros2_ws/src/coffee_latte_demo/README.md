...
colcon build --packages-select coffee_latte_demo
```

## 依赖

- ROS 2: rclpy, std_msgs, std_srvs
- ivg_interfaces (SetRobotIO, RobotIOStatus)
- aubo_driver_ros2 (IO 硬件抽象)

## 参考

- 前端面板: `web/public/coffee_latte_panel.html`
- CLAUDE.md §19 `ivg_interfaces` 统一接口包

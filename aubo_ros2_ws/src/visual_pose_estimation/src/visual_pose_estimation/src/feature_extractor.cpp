...
// 提取特征：从连通域列表中提取所有特征（多线程处理）
// @param components 连通域列表
// @return 特征列表
...
// 计算标准化角度（从工件中心到阀体中心的角度）
// @param workpiece_center 工件中心点
// @param valve_center 阀体中心点
// @return 角度（弧度）

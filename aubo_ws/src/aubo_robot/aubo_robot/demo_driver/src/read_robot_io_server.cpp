    ...
    , io_states_topic_("/aubo_driver/io_states")
{
    ...
    // 初始化服务服务器
    read_robot_io_service_ = nh_.advertiseService("/demo_driver/read_robot_io",
                                                   &ReadRobotIOServer::readRobotIOCallback, this);

    ROS_INFO("ReadRobotIOServer initialized, service '/demo_driver/read_robot_io' is ready");
}

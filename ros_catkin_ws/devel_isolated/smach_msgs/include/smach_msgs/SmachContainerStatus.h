...
struct SmachContainerStatus_
{
  ...
  _initial_states_type initial_states;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _active_states_type;
...
struct Printer< ::smach_msgs::SmachContainerStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smach_msgs::SmachContainerStatus_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "initial_states: ";
    if (v.initial_states.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.initial_states.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.initial_states[i]);
    }
    if (v.initial_states.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "active_states: ";
    if (v.active_states.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.active_states.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.active_states[i]);
    }
    if (v.active_states.empty() || true)
      s << "]";
    if (true || !indent.empty())

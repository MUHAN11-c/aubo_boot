...
struct SmachContainerStructure_
{
  ...
  _children_type children;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _internal_outcomes_type;
  _internal_outcomes_type internal_outcomes;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _outcomes_from_type;
  _outcomes_from_type outcomes_from;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _outcomes_to_type;
  _outcomes_to_type outcomes_to;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _container_outcomes_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smach_msgs::SmachContainerStructure_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.children.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.children[i]);
    }
    if (v.children.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "internal_outcomes: ";
    if (v.internal_outcomes.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.internal_outcomes.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.internal_outcomes[i]);
    }
    if (v.internal_outcomes.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "outcomes_from: ";
    if (v.outcomes_from.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.outcomes_from.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.outcomes_from[i]);
    }
    if (v.outcomes_from.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "outcomes_to: ";
    if (v.outcomes_to.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.outcomes_to.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.outcomes_to[i]);
    }
    if (v.outcomes_to.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "container_outcomes: ";
    if (v.container_outcomes.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.container_outcomes.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.container_outcomes[i]);
    }
    if (v.container_outcomes.empty() || true)
      s << "]";
  }

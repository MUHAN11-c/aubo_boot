...
Author: Charles R. Qi（vendored 自 graspnet-baseline）
"""
import torch
import torch.nn as nn

from graspnet_ros2.graspnet_lib.pointnet2_modules import PointnetFPModule, PointnetSAModuleVotes


class Pointnet2Backbone(nn.Module):
    """ Pointnet++ backbone：4 层 Set Abstraction（SA）下采样 + 2 层 Feature Propagation（FP）上采样，输出 fp2 的坐标与特征。 """

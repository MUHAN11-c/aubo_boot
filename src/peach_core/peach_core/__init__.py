"""
peach_core — 桃子采摘链路公共纯核库（重构阶段 A1）.

纯核零 ROS import（peach_core.ros 子包除外，AST 测试强制）。公共 API
汇总导出；ROS 适配器请显式 ``from peach_core.ros.clock_adapter import
...
from peach_core.harvest_data import default_harvest_root, HarvestDataStore

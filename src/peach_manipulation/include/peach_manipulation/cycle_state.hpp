// 功能：周期状态枚举。终局只认枚举；字符串只作 ~/status 投影。
#ifndef PEACH_MANIPULATION__CYCLE_STATE_HPP_
#define PEACH_MANIPULATION__CYCLE_STATE_HPP_
...
#endif  // PEACH_MANIPULATION__CYCLE_STATE_HPP_

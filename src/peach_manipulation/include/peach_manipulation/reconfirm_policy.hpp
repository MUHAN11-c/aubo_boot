// 功能：抓取前再确认纯核（身份、锚点漂移、摆动平息）。不等待、不阻塞。
#ifndef PEACH_MANIPULATION__RECONFIRM_POLICY_HPP_
#define PEACH_MANIPULATION__RECONFIRM_POLICY_HPP_
...
#endif  // PEACH_MANIPULATION__RECONFIRM_POLICY_HPP_

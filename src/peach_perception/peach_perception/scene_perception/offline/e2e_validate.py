...
示例::
    ...
    aubo_py3.12/bin/python -m peach_perception.scene_perception.offline.e2e_validate \
...
def main():
    ...
    parser = argparse.ArgumentParser(description='场景感知 RGB-D 离线端到端验证')
    ...
    # peach_perception/ 模块目录，不含 model/）

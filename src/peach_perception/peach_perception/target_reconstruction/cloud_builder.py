...
单位约定:
  - 深度图为 uint16「毫米」[mm]（上游经
    peach_perception.common.depth_geometry.normalize_depth_to_uint16_mm
...
from peach_perception.target_reconstruction.interfaces import CLOUD_BUILDERS, CloudBuilder

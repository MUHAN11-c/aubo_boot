...
职责边界：TargetReconstructionNode 的发布侧全部入口（心跳三件套、状态变化
...
采集/精化等写路径留在 target_reconstruction_node.py。
...
宿主契约（mixin，TargetReconstructionNode 提供）：
...
from peach_perception.target_reconstruction.cloud_builder import pack_rgb_bgr
...
from peach_perception.target_reconstruction.visualization import (

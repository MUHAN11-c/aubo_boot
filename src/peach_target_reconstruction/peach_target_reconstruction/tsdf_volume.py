...
from peach_common_py.tf_utils import invert_transform
from peach_target_reconstruction.interfaces import Volume, VOLUMES
    ...
    def __init__(self, voxel_length: float = 0.003, sdf_trunc: float = 0.012,
        ...
        Args:
            ...
            now: 单调时钟（返回 float 秒，协议 I3 由编排层注入，如
                peach_common_py.ros.RclpyClockAdapter.now）；None 回退

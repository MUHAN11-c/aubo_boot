...
from .path_resolver import resolve_templates_root
...
class VisualPoseEstimationNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("soft_trigger_topic", "/camera/soft_trigger")
        self.declare_parameter("base_frame", "base_link")
        self.declare_parameter("ee_frame", "tcp")
    ...
    def _delayed_initialize(self):
        ...
        try:
            ...
            self.get_logger().info("阈值参数: default_config.yaml (通过 ConfigReader 加载)")
            if self.calib_file:

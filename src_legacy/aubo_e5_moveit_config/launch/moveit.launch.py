...
def generate_launch_description():
    standalone = DeclareLaunchArgument(
    ...
    #   totg.resample_dt 0.1→0.01，输出路点密度匹配 100 Hz 执行采样。
    ...
    ompl_pipeline = {
        ...
        # resample_dt 0.1→0.01，输出路点密度匹配 100 Hz 执行采样。
    ...
    controllers = {'moveit_simple_controller_manager': load('aubo_e5_moveit_config', 'config/controllers.yaml'),
    ...
    return LaunchDescription([standalone,

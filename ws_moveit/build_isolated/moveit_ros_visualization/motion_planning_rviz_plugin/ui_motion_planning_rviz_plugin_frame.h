...
public:
    ...
    void setupUi(QWidget *MotionPlanningUI)
    {
        ...
        collision_objects_list->setSelectionMode(QAbstractItemView::ExtendedSelection);
        ...
        QWidget::setTabOrder(tabWidget, planning_pipeline_combo_box);
        QWidget::setTabOrder(planning_pipeline_combo_box, planning_algorithm_combo_box);
        ...
        QWidget::setTabOrder(shape_size_x_spin_box, shape_size_y_spin_box);
        QWidget::setTabOrder(shape_size_y_spin_box, shape_size_z_spin_box);
        QWidget::setTabOrder(shape_size_z_spin_box, shapes_combo_box);

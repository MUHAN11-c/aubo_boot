...
public:
    ...
    void retranslateUi(QWidget *MotionPlanningFrameJointsUI)
    {
        ...
        radio_degree_->setText(QCoreApplication::translate("MotionPlanningFrameJointsUI", "degree", nullptr));
        radio_radian_->setText(QCoreApplication::translate("MotionPlanningFrameJointsUI", "radian", nullptr));

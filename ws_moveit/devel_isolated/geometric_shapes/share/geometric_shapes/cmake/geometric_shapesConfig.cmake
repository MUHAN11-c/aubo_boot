...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /home/mu/IVG/ws_moveit/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /home/mu/IVG/ws_moveit/devel_isolated/geometric_shapes)
  ...
  set(geometric_shapes_INSTALL_PREFIX /home/mu/IVG/ws_moveit/install_isolated)
...
if(NOT "/home/mu/IVG/ws_moveit/src/geometric_shapes/include;/usr/local/include/eigen3;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/home/mu/IVG/ws_moveit/src/geometric_shapes/include;/usr/local/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mu/IVG/ws_moveit/src/geometric_shapes/${idir}'.  ${_report}")
    endif()
    _list_append_unique(geometric_shapes_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "geometric_shapes;/usr/lib/x86_64-linux-gnu/liboctomap.so;/usr/lib/x86_64-linux-gnu/liboctomath.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.1.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mu/IVG/ws_moveit/devel_isolated/geometric_shapes/lib;/home/mu/IVG/ws_moveit/install_isolated/lib;/home/mu/IVG/ros_catkin_ws/install_isolated/lib)

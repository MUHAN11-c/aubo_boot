...
if("TRUE" STREQUAL "TRUE")
  set(rosparam_shortcuts_SOURCE_PREFIX /home/mu/IVG/ws_moveit/src/rosparam_shortcuts)
  set(rosparam_shortcuts_DEVEL_PREFIX /home/mu/IVG/ws_moveit/devel_isolated/rosparam_shortcuts)
  ...
  set(rosparam_shortcuts_INSTALL_PREFIX /home/mu/IVG/ws_moveit/install_isolated)
...
if(NOT "/home/mu/IVG/ws_moveit/src/rosparam_shortcuts/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(rosparam_shortcuts_INCLUDE_DIRS "")
  set(_include_dirs "/home/mu/IVG/ws_moveit/src/rosparam_shortcuts/include;/usr/local/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosparam_shortcuts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mu/IVG/ws_moveit/src/rosparam_shortcuts/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mu/IVG/ws_moveit/devel_isolated/rosparam_shortcuts/lib;/home/mu/IVG/ws_moveit/install_isolated/lib;/home/mu/IVG/ros_catkin_ws/install_isolated/lib)
